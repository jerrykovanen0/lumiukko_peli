        ...
        ENDHLSL
         ...
         inputData.normalizedScreenSpaceUV = GetNormalizedScreenSpaceUV(screenPos);
                 ...
                 LIGHT_LOOP_END
                     ...
                     // add in the sparkles
                         float sparklesStatic =
        tex2D(_SparkleNoise,
              IN.worldPos.xz * _SparkleScale).r;

    float cutoffSparkles =
        step(_SparkCutoff, sparklesStatic);

    litMainColors.rgb += cutoffSparkles * 4;
